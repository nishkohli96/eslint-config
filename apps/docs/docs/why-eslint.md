...
Besides error catching, eslint rules are also capable of formatting your code which makes it feel consistent, especially when working with a large team. One such popular framework which was widely used for formatting the code is [prettier](https://prettier.io/).
