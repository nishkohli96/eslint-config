...
|[@stylistic/comma-dangle](https://eslint.style/rules/default/comma-dangle) | Moved to 🗑️ |
|[@stylistic/object-curly-newline](https://eslint.style/rules/default/object-curly-newline)| `multiline` -> `consistent` |
|[@stylistic/object-property-newline](https://eslint.style/rules/default/object-property-newline)| Moved to 🗑️ |
