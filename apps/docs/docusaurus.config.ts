  ...
  themeConfig: {
    ...
    footer: {
      ...
      links: [
        ...
        {
          html: `
            <a href="https://instagram.com/nocturnal_nish" target="_blank" rel="noreferrer noopener" aria-label="Nishant's Instagram">
        ...
        {
          html: `
            <a href="mailto:nishantkohli96@gmail.com" target="_blank" rel="noreferrer noopener" aria-label="Email Nishant">
