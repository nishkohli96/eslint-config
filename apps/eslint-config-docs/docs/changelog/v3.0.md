...
- Set [@typescript-eslint/require-await](https://typescript-eslint.io/rules/require-await) to **warn**.
- Add [@stylistic/js/function-call-spacing](https://eslint.style/rules/js/function-call-spacing) rule
